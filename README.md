...
* [`src/clj/exmod/`](src/clj/exmod/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/exmod/`](src/cljs/exmod/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/exmod/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `exmod` project root directory
...
in the [`src/clj/exmod/`](src/clj/exmod/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/exmod/config.cljs) defaults to `true` in
...
```clj
(ns exmod.example
  (:require [exmod.config :as config])
